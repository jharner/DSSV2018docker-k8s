...
These technologies form the basis for solving the data analysis issues mentioned above. Docker Swarm is also an orchestation option, but not as scalable or feature complete as Kubernetes. At the other extreme, Mesos is for huge containerization deployments.
...
Increasingly these platforms are being built on Kubernetes.
