...
Kubernetes is a system for running and coordinating related containerized applications across a cluster of (typically virtual) machines. It is a platform that manages the complete lifecycles of containerized applications and services to provide:  
